...
Generate content for section `section-03-frameworks-catalog` (filename: `section-03-frameworks-catalog.md`).
...
for `section-03-frameworks-catalog` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/plans/frontend-pages/sections/section-03-frameworks-catalog.md`
