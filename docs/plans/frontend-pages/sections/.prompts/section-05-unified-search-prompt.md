...
Generate content for section `section-05-unified-search` (filename: `section-05-unified-search.md`).
...
for `section-05-unified-search` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/plans/frontend-pages/sections/section-05-unified-search.md`
