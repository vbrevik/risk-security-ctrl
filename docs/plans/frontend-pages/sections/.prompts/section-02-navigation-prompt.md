...
Generate content for section `section-02-navigation` (filename: `section-02-navigation.md`).
...
for `section-02-navigation` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/plans/frontend-pages/sections/section-02-navigation.md`
