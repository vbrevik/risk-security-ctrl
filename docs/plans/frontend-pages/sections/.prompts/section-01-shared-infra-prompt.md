...
Generate content for section `section-01-shared-infra` (filename: `section-01-shared-infra.md`).
...
for `section-01-shared-infra` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/plans/frontend-pages/sections/section-01-shared-infra.md`
