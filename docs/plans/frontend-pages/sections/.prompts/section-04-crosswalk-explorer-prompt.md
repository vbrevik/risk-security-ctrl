...
Generate content for section `section-04-crosswalk-explorer` (filename: `section-04-crosswalk-explorer.md`).
...
for `section-04-crosswalk-explorer` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/plans/frontend-pages/sections/section-04-crosswalk-explorer.md`
