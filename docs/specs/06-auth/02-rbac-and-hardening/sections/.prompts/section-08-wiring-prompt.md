...
Generate content for section `section-08-wiring` (filename: `section-08-wiring.md`).
...
for `section-08-wiring` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-08-wiring.md`
