...
Generate content for section `section-07-session-cleanup` (filename: `section-07-session-cleanup.md`).
...
for `section-07-session-cleanup` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-07-session-cleanup.md`
