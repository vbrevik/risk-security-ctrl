...
Generate content for section `section-04-rate-limiting` (filename: `section-04-rate-limiting.md`).
...
for `section-04-rate-limiting` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-04-rate-limiting.md`
