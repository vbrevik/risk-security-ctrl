...
Generate content for section `section-05-security-headers` (filename: `section-05-security-headers.md`).
...
for `section-05-security-headers` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-05-security-headers.md`
