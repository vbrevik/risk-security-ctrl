...
Generate content for section `section-03-rbac-middleware` (filename: `section-03-rbac-middleware.md`).
...
for `section-03-rbac-middleware` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-03-rbac-middleware.md`
