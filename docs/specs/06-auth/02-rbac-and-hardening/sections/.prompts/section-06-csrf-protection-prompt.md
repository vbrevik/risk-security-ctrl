...
Generate content for section `section-06-csrf-protection` (filename: `section-06-csrf-protection.md`).
...
for `section-06-csrf-protection` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-06-csrf-protection.md`
