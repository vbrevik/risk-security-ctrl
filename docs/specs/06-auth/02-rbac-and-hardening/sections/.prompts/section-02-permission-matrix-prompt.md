...
Generate content for section `section-02-permission-matrix` (filename: `section-02-permission-matrix.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/claude-plan.md` - Full implementation plan
2. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-permission-matrix` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/02-rbac-and-hardening/sections/section-02-permission-matrix.md`
