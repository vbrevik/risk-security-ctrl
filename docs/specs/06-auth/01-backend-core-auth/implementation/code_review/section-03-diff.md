...
+pub mod password;
 pub mod routes;
diff --git a/backend/src/features/auth/password.rs b/backend/src/features/auth/password.rs
new file mode 100644
index 0000000..e598b60
--- /dev/null
+++ b/backend/src/features/auth/password.rs
@@ -0,0 +1,100 @@
+use argon2::{
