...
@@ -1,3 +1,4 @@
 ...
 pub mod routes;
+pub mod service;
diff --git a/backend/src/features/auth/service.rs b/backend/src/features/auth/service.rs
new file mode 100644
index 0000000..2d27b21
--- /dev/null
+++ b/backend/src/features/auth/service.rs
@@ -0,0 +1,441 @@
+use sqlx::SqlitePool;
+use uuid::Uuid;
+
