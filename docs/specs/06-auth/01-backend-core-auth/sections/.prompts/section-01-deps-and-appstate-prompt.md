...
Generate content for section `section-01-deps-and-appstate` (filename: `section-01-deps-and-appstate.md`).
...
for `section-01-deps-and-appstate` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-01-deps-and-appstate.md`
