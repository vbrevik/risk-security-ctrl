...
Generate content for section `section-05-auth-extractor` (filename: `section-05-auth-extractor.md`).
...
for `section-05-auth-extractor` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-05-auth-extractor.md`
