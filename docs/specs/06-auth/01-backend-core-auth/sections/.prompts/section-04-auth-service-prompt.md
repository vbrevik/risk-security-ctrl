...
Generate content for section `section-04-auth-service` (filename: `section-04-auth-service.md`).
...
for `section-04-auth-service` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-04-auth-service.md`
