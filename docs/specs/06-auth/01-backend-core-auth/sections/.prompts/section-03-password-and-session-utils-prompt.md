...
Generate content for section `section-03-password-and-session-utils` (filename: `section-03-password-and-session-utils.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/claude-plan.md` - Full implementation plan
2. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-password-and-session-utils` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-03-password-and-session-utils.md`
