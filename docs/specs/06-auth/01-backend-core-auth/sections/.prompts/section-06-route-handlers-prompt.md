...
Generate content for section `section-06-route-handlers` (filename: `section-06-route-handlers.md`).
...
for `section-06-route-handlers` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-06-route-handlers.md`
