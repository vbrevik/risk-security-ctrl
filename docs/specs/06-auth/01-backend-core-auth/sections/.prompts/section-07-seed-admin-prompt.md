...
Generate content for section `section-07-seed-admin` (filename: `section-07-seed-admin.md`).
...
for `section-07-seed-admin` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-07-seed-admin.md`
