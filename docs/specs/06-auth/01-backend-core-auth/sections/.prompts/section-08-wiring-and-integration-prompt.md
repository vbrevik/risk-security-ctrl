...
Generate content for section `section-08-wiring-and-integration` (filename: `section-08-wiring-and-integration.md`).
...
for `section-08-wiring-and-integration` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-08-wiring-and-integration.md`
