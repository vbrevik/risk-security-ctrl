...
Generate content for section `section-02-auth-models` (filename: `section-02-auth-models.md`).
...
for `section-02-auth-models` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/01-backend-core-auth/sections/section-02-auth-models.md`
