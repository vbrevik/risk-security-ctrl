...
Generate content for section `section-01-api-client` (filename: `section-01-api-client.md`).
...
for `section-01-api-client` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-01-api-client.md`
