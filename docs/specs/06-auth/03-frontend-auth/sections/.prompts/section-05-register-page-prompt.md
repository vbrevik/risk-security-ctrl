...
Generate content for section `section-05-register-page` (filename: `section-05-register-page.md`).
...
for `section-05-register-page` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-05-register-page.md`
