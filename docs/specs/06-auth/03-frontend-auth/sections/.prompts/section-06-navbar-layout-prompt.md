...
Generate content for section `section-06-navbar-layout` (filename: `section-06-navbar-layout.md`).
...
for `section-06-navbar-layout` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-06-navbar-layout.md`
