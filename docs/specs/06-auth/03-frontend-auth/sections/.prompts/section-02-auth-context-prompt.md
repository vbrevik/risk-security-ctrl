...
Generate content for section `section-02-auth-context` (filename: `section-02-auth-context.md`).
...
for `section-02-auth-context` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-02-auth-context.md`
