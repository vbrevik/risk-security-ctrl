...
Generate content for section `section-04-login-page` (filename: `section-04-login-page.md`).
...
for `section-04-login-page` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-04-login-page.md`
