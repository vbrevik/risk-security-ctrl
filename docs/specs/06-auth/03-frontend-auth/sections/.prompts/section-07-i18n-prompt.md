...
Generate content for section `section-07-i18n` (filename: `section-07-i18n.md`).
...
for `section-07-i18n` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-07-i18n.md`
