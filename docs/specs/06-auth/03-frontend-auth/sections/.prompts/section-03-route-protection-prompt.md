...
Generate content for section `section-03-route-protection` (filename: `section-03-route-protection.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/claude-plan.md` - Full implementation plan
2. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-route-protection` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/06-auth/03-frontend-auth/sections/section-03-route-protection.md`
