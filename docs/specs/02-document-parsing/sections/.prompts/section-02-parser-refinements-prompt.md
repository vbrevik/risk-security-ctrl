...
Generate content for section `section-02-parser-refinements` (filename: `section-02-parser-refinements.md`).
...
for `section-02-parser-refinements` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-02-parser-refinements.md`
