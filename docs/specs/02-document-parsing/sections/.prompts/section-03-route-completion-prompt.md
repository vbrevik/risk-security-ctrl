...
Generate content for section `section-03-route-completion` (filename: `section-03-route-completion.md`).
...
for `section-03-route-completion` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-03-route-completion.md`
