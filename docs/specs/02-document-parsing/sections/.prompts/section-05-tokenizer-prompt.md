...
Generate content for section `section-05-tokenizer` (filename: `section-05-tokenizer.md`).
...
for `section-05-tokenizer` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-05-tokenizer.md`
