...
Generate content for section `section-01-upload-handler` (filename: `section-01-upload-handler.md`).
...
for `section-01-upload-handler` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-01-upload-handler.md`
