...
Generate content for section `section-03-fts5-retrieval` (filename: `section-03-fts5-retrieval.md`).
...
for `section-03-fts5-retrieval` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-03-fts5-retrieval.md`
