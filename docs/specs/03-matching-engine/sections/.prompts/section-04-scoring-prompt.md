...
Generate content for section `section-04-scoring` (filename: `section-04-scoring.md`).
...
for `section-04-scoring` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-04-scoring.md`
