...
Generate content for section `section-05-classification` (filename: `section-05-classification.md`).
...
for `section-05-classification` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-05-classification.md`
