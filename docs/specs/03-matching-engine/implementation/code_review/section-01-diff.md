...
+
+    #[serde(default = "default_include_addressed")]
+    pub include_addressed_findings: bool,
+
+    #[serde(default = "default_boost_terms")]
...
+    0.1
+}
+fn default_addressed() -> f64 {
+    0.6
+}
+fn default_partial() -> f64 {
+    0.3
+}
+fn default_max_findings() -> usize {
+    50
+}
+fn default_include_addressed() -> bool {
+    true
+}
+fn default_boost_terms() -> HashMap<String, f64> {
+    HashMap::from([
+        ("security".into(), 1.5),
+        ("risk".into(), 1.5),
+        ("compliance".into(), 1.3),
...
+            addressed_threshold: default_addressed(),
+            partial_threshold: default_partial(),
+            max_findings_per_framework: default_max_findings(),
+            include_addressed_findings: default_include_addressed(),
+            boost_terms: default_boost_terms(),
+        }
+    }
+}
+
...
+///
+/// Carries all the same fields as `ConceptCandidate` plus a `confidence_score`
