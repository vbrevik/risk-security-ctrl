...
Generate content for section `section-02-heatmap-cross-filter` (filename: `section-02-heatmap-cross-filter.md`).
...
for `section-02-heatmap-cross-filter` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/03-analysis-enhancements/sections/section-02-heatmap-cross-filter.md`
