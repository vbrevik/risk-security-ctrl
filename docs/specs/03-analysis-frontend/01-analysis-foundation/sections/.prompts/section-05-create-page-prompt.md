...
Generate content for section `section-05-create-page` (filename: `section-05-create-page.md`).
...
for `section-05-create-page` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/01-analysis-foundation/sections/section-05-create-page.md`
