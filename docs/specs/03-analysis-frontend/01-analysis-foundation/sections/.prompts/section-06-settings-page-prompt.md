...
Generate content for section `section-06-settings-page` (filename: `section-06-settings-page.md`).
...
for `section-06-settings-page` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/01-analysis-foundation/sections/section-06-settings-page.md`
