...
Generate content for section `section-04-list-page` (filename: `section-04-list-page.md`).
...
for `section-04-list-page` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/01-analysis-foundation/sections/section-04-list-page.md`
