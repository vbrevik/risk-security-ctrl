...
Generate content for section `section-03-shadcn-components` (filename: `section-03-shadcn-components.md`).
...
for `section-03-shadcn-components` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/01-analysis-foundation/sections/section-03-shadcn-components.md`
