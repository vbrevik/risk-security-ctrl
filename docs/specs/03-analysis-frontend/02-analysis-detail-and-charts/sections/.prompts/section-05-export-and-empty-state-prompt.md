...
Generate content for section `section-05-export-and-empty-state` (filename: `section-05-export-and-empty-state.md`).
...
for `section-05-export-and-empty-state` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/sections/section-05-export-and-empty-state.md`
