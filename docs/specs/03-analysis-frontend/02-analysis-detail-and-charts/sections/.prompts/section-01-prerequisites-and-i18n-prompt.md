...
Generate content for section `section-01-prerequisites-and-i18n` (filename: `section-01-prerequisites-and-i18n.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/claude-plan.md` - Full implementation plan
2. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-prerequisites-and-i18n` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/sections/section-01-prerequisites-and-i18n.md`
