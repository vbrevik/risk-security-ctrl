...
Generate content for section `section-04-findings-table` (filename: `section-04-findings-table.md`).
...
for `section-04-findings-table` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/sections/section-04-findings-table.md`
