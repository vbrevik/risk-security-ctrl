...
Generate content for section `section-03-d3-charts` (filename: `section-03-d3-charts.md`).
...
for `section-03-d3-charts` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-analysis-frontend/02-analysis-detail-and-charts/sections/section-03-d3-charts.md`
