...
Generate content for section `section-03-models` (filename: `section-03-models.md`).
...
for `section-03-models` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/01-db-models/sections/section-03-models.md`
