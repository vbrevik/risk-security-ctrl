...
Generate content for section `section-07-chart-rendering` (filename: `section-07-chart-rendering.md`).
...
for `section-07-chart-rendering` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-07-chart-rendering.md`
