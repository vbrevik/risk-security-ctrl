...
Generate content for section `section-03-create-analysis-text` (filename: `section-03-create-analysis-text.md`).
...
for `section-03-create-analysis-text` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-03-create-analysis-text.md`
