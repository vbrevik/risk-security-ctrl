...
Generate content for section `section-04-file-upload` (filename: `section-04-file-upload.md`).
...
for `section-04-file-upload` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-04-file-upload.md`
