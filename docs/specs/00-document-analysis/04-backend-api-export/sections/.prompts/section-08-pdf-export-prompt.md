...
Generate content for section `section-08-pdf-export` (filename: `section-08-pdf-export.md`).
...
for `section-08-pdf-export` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-08-pdf-export.md`
