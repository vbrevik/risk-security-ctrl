...
Generate content for section `section-11-prompt-template` (filename: `section-11-prompt-template.md`).
...
for `section-11-prompt-template` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-11-prompt-template.md`
