...
Generate content for section `section-05-list-get-delete` (filename: `section-05-list-get-delete.md`).
...
for `section-05-list-get-delete` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-05-list-get-delete.md`
