...
Generate content for section `section-06-findings-endpoint` (filename: `section-06-findings-endpoint.md`).
...
for `section-06-findings-endpoint` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-06-findings-endpoint.md`
