...
Generate content for section `section-01-config-types` (filename: `section-01-config-types.md`).
...
for `section-01-config-types` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-01-config-types.md`
