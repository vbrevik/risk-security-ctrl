...
Generate content for section `section-06-matcher-impl` (filename: `section-06-matcher-impl.md`).
...
for `section-06-matcher-impl` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-06-matcher-impl.md`
