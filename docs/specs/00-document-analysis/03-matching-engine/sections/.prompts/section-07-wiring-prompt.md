...
Generate content for section `section-07-wiring` (filename: `section-07-wiring.md`).
...
for `section-07-wiring` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/03-matching-engine/sections/section-07-wiring.md`
