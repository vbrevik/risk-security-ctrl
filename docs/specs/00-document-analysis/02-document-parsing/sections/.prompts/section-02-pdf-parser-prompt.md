...
Generate content for section `section-02-pdf-parser` (filename: `section-02-pdf-parser.md`).
...
for `section-02-pdf-parser` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-02-pdf-parser.md`
