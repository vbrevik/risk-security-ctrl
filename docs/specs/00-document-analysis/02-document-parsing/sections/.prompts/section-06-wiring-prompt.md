...
Generate content for section `section-06-wiring` (filename: `section-06-wiring.md`).
...
for `section-06-wiring` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-06-wiring.md`
