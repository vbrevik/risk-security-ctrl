...
Generate content for section `section-03-docx-parser` (filename: `section-03-docx-parser.md`).
...
for `section-03-docx-parser` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/02-document-parsing/sections/section-03-docx-parser.md`
