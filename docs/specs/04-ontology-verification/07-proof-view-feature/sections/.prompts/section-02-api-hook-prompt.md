...
Generate content for section `section-02-api-hook` (filename: `section-02-api-hook.md`).
...
for `section-02-api-hook` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-ontology-verification/07-proof-view-feature/sections/section-02-api-hook.md`
