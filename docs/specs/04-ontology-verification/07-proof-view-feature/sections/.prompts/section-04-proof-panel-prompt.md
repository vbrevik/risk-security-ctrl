...
Generate content for section `section-04-proof-panel` (filename: `section-04-proof-panel.md`).
...
for `section-04-proof-panel` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-ontology-verification/07-proof-view-feature/sections/section-04-proof-panel.md`
