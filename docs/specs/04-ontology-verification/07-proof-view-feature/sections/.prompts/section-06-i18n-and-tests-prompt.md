...
Generate content for section `section-06-i18n-and-tests` (filename: `section-06-i18n-and-tests.md`).
...
for `section-06-i18n-and-tests` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-ontology-verification/07-proof-view-feature/sections/section-06-i18n-and-tests.md`
