...
Generate content for section `section-02-enums` (filename: `section-02-enums.md`).
...
for `section-02-enums` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/01-db-models/sections/section-02-enums.md`
