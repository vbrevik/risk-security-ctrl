...
Generate content for section `section-02-concept-detail-handler` (filename: `section-02-concept-detail-handler.md`).
...
for `section-02-concept-detail-handler` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/03-api-matcher/sections/section-02-concept-detail-handler.md`
