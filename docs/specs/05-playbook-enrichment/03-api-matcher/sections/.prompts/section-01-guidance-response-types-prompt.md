...
Generate content for section `section-01-guidance-response-types` (filename: `section-01-guidance-response-types.md`).
...
for `section-01-guidance-response-types` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/03-api-matcher/sections/section-01-guidance-response-types.md`
