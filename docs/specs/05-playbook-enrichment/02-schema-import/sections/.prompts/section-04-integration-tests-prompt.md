...
Generate content for section `section-04-integration-tests` (filename: `section-04-integration-tests.md`).
...
for `section-04-integration-tests` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/02-schema-import/sections/section-04-integration-tests.md`
