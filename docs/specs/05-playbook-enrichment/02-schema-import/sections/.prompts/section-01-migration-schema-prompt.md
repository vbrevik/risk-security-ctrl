...
Generate content for section `section-01-migration-schema` (filename: `section-01-migration-schema.md`).
...
for `section-01-migration-schema` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/02-schema-import/sections/section-01-migration-schema.md`
