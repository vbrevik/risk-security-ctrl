...
Generate content for section `section-02-page-offset-detection` (filename: `section-02-page-offset-detection.md`).
...
for `section-02-page-offset-detection` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/section-02-page-offset-detection.md`
