...
Generate content for section `section-06-integration-tests` (filename: `section-06-integration-tests.md`).
...
for `section-06-integration-tests` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/section-06-integration-tests.md`
