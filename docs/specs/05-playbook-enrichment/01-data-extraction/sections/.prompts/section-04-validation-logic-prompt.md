...
Generate content for section `section-04-validation-logic` (filename: `section-04-validation-logic.md`).
...
for `section-04-validation-logic` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/section-04-validation-logic.md`
