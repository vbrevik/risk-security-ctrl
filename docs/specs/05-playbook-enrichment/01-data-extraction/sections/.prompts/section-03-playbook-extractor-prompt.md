...
Generate content for section `section-03-playbook-extractor` (filename: `section-03-playbook-extractor.md`).
...
for `section-03-playbook-extractor` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/section-03-playbook-extractor.md`
