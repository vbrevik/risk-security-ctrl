...
Generate content for section `section-01-extractor-trait-and-types` (filename: `section-01-extractor-trait-and-types.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/claude-plan.md` - Full implementation plan
2. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-extractor-trait-and-types` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/05-playbook-enrichment/01-data-extraction/sections/section-01-extractor-trait-and-types.md`
