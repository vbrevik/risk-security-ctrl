...
Generate content for section `section-10-export-handler` (filename: `section-10-export-handler.md`).
...
for `section-10-export-handler` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-10-export-handler.md`
