...
Generate content for section `section-02-route-scaffold-and-wiring` (filename: `section-02-route-scaffold-and-wiring.md`).
...
for `section-02-route-scaffold-and-wiring` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-02-route-scaffold-and-wiring.md`
