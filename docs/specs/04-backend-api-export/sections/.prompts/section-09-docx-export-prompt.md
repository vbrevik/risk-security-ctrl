...
Generate content for section `section-09-docx-export` (filename: `section-09-docx-export.md`).
...
for `section-09-docx-export` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/risk-security-ctrl/docs/specs/04-backend-api-export/sections/section-09-docx-export.md`
