...
const ALL_IDS = [
  "iso31000", "iso31010", "iso27000", "iso9000", "iso10015", "nist-csf", "nist-800-53", "nist-rmf", "mitre-attack", "cwe",
...
describe("groupFrameworksByDomain", () => {
  ...
  it("each group contains expected framework IDs", () => {
    ...
    expect(byLabel["Risk & Security Standards"]).toEqual(
      expect.arrayContaining(["iso31000", "iso31010", "iso27000", "iso9000", "iso10015", "nist-csf", "nist-800-53", "nist-rmf", "mitre-attack", "cwe"])
    );
